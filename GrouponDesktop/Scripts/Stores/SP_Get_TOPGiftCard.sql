...
AS
BEGIN
SELECT TOP 5 crg.ID_Cliente_Destino, u.Nombre, crg.credito, gst.consumo
FROM
(
...
INNER JOIN GRUPO_N.Usuario u ON u.ID=crg.ID_Cliente_Destino
WHERE
crg.credito <= gst.consumo
