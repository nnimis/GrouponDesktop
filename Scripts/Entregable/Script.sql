...
/****** Object:  Database [GD1C2012]    Script Date: 10/20/2012 11:55:02 ******/
CREATE DATABASE [GD1C2012] ON  PRIMARY 
( NAME = N'GD1C2012', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL10.SQLEXPRESS\MSSQL\DATA\GD1C2012.mdf' , SIZE = 1011712KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'GD1C2012_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL10.SQLEXPRESS\MSSQL\DATA\GD1C2012_log.ldf' , SIZE = 1024KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO

ALTER DATABASE [GD1C2012] SET COMPATIBILITY_LEVEL = 100
GO

IF (1 = FULLTEXTSERVICEPROPERTY('IsFullTextInstalled'))
begin
EXEC [GD1C2012].[dbo].[sp_fulltext_database] @action = 'enable'
end
GO

ALTER DATABASE [GD1C2012] SET ANSI_NULL_DEFAULT OFF 
GO

ALTER DATABASE [GD1C2012] SET ANSI_NULLS OFF 
GO

ALTER DATABASE [GD1C2012] SET ANSI_PADDING OFF 
GO

ALTER DATABASE [GD1C2012] SET ANSI_WARNINGS OFF 
GO

ALTER DATABASE [GD1C2012] SET ARITHABORT OFF 
GO

ALTER DATABASE [GD1C2012] SET AUTO_CLOSE OFF 
GO

ALTER DATABASE [GD1C2012] SET AUTO_CREATE_STATISTICS ON 
GO

ALTER DATABASE [GD1C2012] SET AUTO_SHRINK OFF 
GO

ALTER DATABASE [GD1C2012] SET AUTO_UPDATE_STATISTICS ON 
GO

ALTER DATABASE [GD1C2012] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO

ALTER DATABASE [GD1C2012] SET CURSOR_DEFAULT  GLOBAL 
GO

ALTER DATABASE [GD1C2012] SET CONCAT_NULL_YIELDS_NULL OFF 
GO

ALTER DATABASE [GD1C2012] SET NUMERIC_ROUNDABORT OFF 
GO

ALTER DATABASE [GD1C2012] SET QUOTED_IDENTIFIER OFF 
GO

ALTER DATABASE [GD1C2012] SET RECURSIVE_TRIGGERS OFF 
GO

ALTER DATABASE [GD1C2012] SET  DISABLE_BROKER 
GO

ALTER DATABASE [GD1C2012] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO

ALTER DATABASE [GD1C2012] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO

ALTER DATABASE [GD1C2012] SET TRUSTWORTHY OFF 
GO

ALTER DATABASE [GD1C2012] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO

ALTER DATABASE [GD1C2012] SET PARAMETERIZATION SIMPLE 
GO

ALTER DATABASE [GD1C2012] SET READ_COMMITTED_SNAPSHOT OFF 
GO

ALTER DATABASE [GD1C2012] SET HONOR_BROKER_PRIORITY OFF 
GO

ALTER DATABASE [GD1C2012] SET  READ_WRITE 
GO

ALTER DATABASE [GD1C2012] SET RECOVERY SIMPLE 
GO

ALTER DATABASE [GD1C2012] SET  MULTI_USER 
GO

ALTER DATABASE [GD1C2012] SET PAGE_VERIFY CHECKSUM  
GO

ALTER DATABASE [GD1C2012] SET DB_CHAINING OFF 
GO
